...
twitch_miner = TwitchChannelPointsMiner(
    ...
    logger_settings=LoggerSettings(
        ...
        color_palette=ColorPalette(             # You can also create a custom palette color (for the common message).
            ...
            BET_wiN=Fore.CYAN               # Color allowed are: [BLACK, RED, GREEN, YELLOW, BLUE, MAGENTA, CYAN, WHITE, RESET].
        ),
        telegram=Telegram(                                                          # You can omit or set to None if you don't want to receive updates on Telegram
            chat_id=5713126628,                                                      # Chat ID to send messages @getmyid_bot
    ...
    streamer_settings=StreamerSettings(
        ...
        bet=BetSettings(
            ...
            percentage_gap=40,                  # Gap difference between outcomesA and outcomesB (for SMART strategy)
...
twitch_miner.mine(
    [
        Streamer("", settings=StreamerSettings(make_predictions=True  , follow_raid=True  , claim_drops=True ,  watch_streak=True , bet=BetSettings(strategy=Strategy.HIGH_ODDS  , percentage=20 , stealth_mode=True,  percentage_gap=20 , max_points=9000    , filter_condition=FilterCondition(by=OutcomeKeys.PERCENTAGE_USERS, where=Condition.GTE, value=1000 ) ) )),
        Streamer("", settings=StreamerSettings(make_predictions=True  , follow_raid=True  , claim_drops=True ,  watch_streak=True , bet=BetSettings(strategy=Strategy.HIGH_ODDS  , percentage=20 , stealth_mode=True,  percentage_gap=20 , max_points=9000    , filter_condition=FilterCondition(by=OutcomeKeys.PERCENTAGE_USERS, where=Condition.GTE, value=1000 ) ) )),
        Streamer("", settings=StreamerSettings(make_predictions=True  , follow_raid=True  , claim_drops=True ,  watch_streak=True , bet=BetSettings(strategy=Strategy.HIGH_ODDS  , percentage=20 , stealth_mode=True,  percentage_gap=20 , max_points=9000    , filter_condition=FilterCondition(by=OutcomeKeys.PERCENTAGE_USERS, where=Condition.GTE, value=1000 ) ) )),
        Streamer("", settings=StreamerSettings(make_predictions=False , follow_raid=True  ,                     watch_streak=True                                                                                                                                                                                                                                 )),
        Streamer("", settings=StreamerSettings(make_predictions=True  , follow_raid=True  , claim_drops=True ,  watch_streak=True , bet=BetSettings(strategy=Strategy.HIGH_ODDS  , percentage=20 , stealth_mode=True,  percentage_gap=20 , max_points=9000    , filter_condition=FilterCondition(by=OutcomeKeys.PERCENTAGE_USERS, where=Condition.GTE, value=1000 ) ) )),
        Streamer(""),
        Streamer(""),
        Streamer(""),
